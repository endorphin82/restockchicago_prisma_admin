  ...
  return (
    <div className="ant-upload-list ant-upload-list-picture">
      <div className=""><span><div
        ...
        className="ant-upload-list-item-info"><span><a
        ...
        className="ant-upload-list-item-card-actions picture"><button
        ...
        role="img" aria-label="delete" tabIndex="-1" className="anticon anticon-delete"><svg
